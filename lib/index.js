...
follow_redirects.maxBodyLength = Infinity;
...
module.exports = class storage_clickhouse {
    constructor(params) {
        ...
        this.timer = null;
        this.timer_miss = 0;
        this.current_timer_interval = params.current_timer_interval || 1000;
        this.timer_default_interval = params.timer_default_interval || 1000;
        this.max_values_per_query = params.max_values_per_query || 50;

        this.enable_log = params.enable_log || false;
    ...
    insert_data_binary(query, stream) {
        var options = {
            'method': 'POST',
            'hostname': 'torus.test',
            'port': 8123,
